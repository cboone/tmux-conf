...
This repository documents tmux default configuration settings. The `defaults/` directory contains reference files showing tmux's built-in options, generated using an unconfigured tmux server (`tmux -L unconfigured -f /dev/null start-server`).
